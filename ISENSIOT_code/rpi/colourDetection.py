...
def takeImage():
    ...
    cv2.imwrite('/home/pi/testimage.jpg', img_bgr)
    img_rgb = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2RGB)
    template_bgr = plt.imread('images/template.jpg')
    ...
    points_list = invariantMatchTemplate(img_rgb, cropped_template_rgb, "TM_CCOEFF_NORMED", 0.6, 500, [0, 90], 30, [25, 80], 5, True)

    centers_list = []
    print(points_list[0][0])
    print(points_list[1][0])
